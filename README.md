...
Lead Score Case Study Lead Scoring Assignment.ipynb : The python file showing coding and data analysis
Assign_Sub_Ques.pdf : Some subjective questions answered
LEAD SCORE CASE STUDY PPT.pdf : Final Presentation
Leads.csv : Data worked on
Summary_case_study.pdf : Summary on what's done in the entire py file